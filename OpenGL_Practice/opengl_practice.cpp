...
float xVal = 0.0f, yVal = 0.0f, zVal = 5.0f;;
...
void display(void)
{
	...
	transformObject(1.0f, XY_AXIS, angle1 += 0.2f, glm::vec3(0.0f, 1.5f, 0.0f));


	glDrawElements(GL_QUADS, 24, GL_UNSIGNED_SHORT, 0);

	transformObject(1.0f, XY_AXIS, angle2 -= 0.2f, glm::vec3(0.0f, -1.5f, 0.0f));
